...
dataset1 <- write.table(train_test_sub, row.name=FALSE)
save(dataset1, file="dataset1.txt")
...
dataset2 <- write.table(averages, row.name=FALSE)
save(dataset2, file="dataset2.txt")
